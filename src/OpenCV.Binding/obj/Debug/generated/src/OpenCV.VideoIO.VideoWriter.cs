...
namespace OpenCV.VideoIO {
	...
	public partial class VideoWriter : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (VideoWriter)) {
					SetHandle (
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (VideoWriter)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/lang/String;IDLorg/opencv/core/Size;)V", __args),
							JniHandleOwnership.TransferLocalRef);
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (VideoWriter)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/lang/String;IDLorg/opencv/core/Size;Z)V", __args),
							JniHandleOwnership.TransferLocalRef);
