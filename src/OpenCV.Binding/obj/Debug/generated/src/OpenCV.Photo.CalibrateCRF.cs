...
namespace OpenCV.Photo {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.opencv.photo']/class[@name='CalibrateCRF']"
	[global::Android.Runtime.Register ("org/opencv/photo/CalibrateCRF", DoNotGenerateAcw=true)]
	public partial class CalibrateCRF : global::OpenCV.Core.Algorithm {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/opencv/photo/CalibrateCRF", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CalibrateCRF); }
		}

		protected CalibrateCRF (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_J;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.opencv.photo']/class[@name='CalibrateCRF']/constructor[@name='CalibrateCRF' and count(parameter)=1 and parameter[1][@type='long']]"
		[Register (".ctor", "(J)V", "")]
		protected unsafe CalibrateCRF (long p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (CalibrateCRF)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::OpenCV.Photo.CalibrateCRF __this = global::Java.Lang.Object.GetObject<global::OpenCV.Photo.CalibrateCRF> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.opencv.photo']/class[@name='CalibrateCRF']/method[@name='process' and count(parameter)=3 and parameter[1][@type='java.util.List&lt;org.opencv.core.Mat&gt;'] and parameter[2][@type='org.opencv.core.Mat'] and parameter[3][@type='org.opencv.core.Mat']]"
