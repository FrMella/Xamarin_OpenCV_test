		...
		public partial class JavaCameraFrame : global::Java.Lang.Object, global::OpenCV.Android.CameraBridgeViewBase.ICvCameraViewFrame {
				...
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (((object) this).GetType () != typeof (JavaCameraFrame)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(L" + global::Android.Runtime.JNIEnv.GetJniName (GetType ().DeclaringType) + ";Lorg/opencv/core/Mat;II)V", __args),
...
#pragma warning restore 0169
		...
		public partial class JavaCameraSizeAccessor : global::Java.Lang.Object, global::OpenCV.Android.CameraBridgeViewBase.IListItemAccessor {
				...
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					if (((object) this).GetType () != typeof (JavaCameraSizeAccessor)) {
						SetHandle (
...
#pragma warning restore 0169
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JValue (p0);
				__args [1] = new JValue (p1);
				if (((object) this).GetType () != typeof (JavaCameraView)) {
					SetHandle (
