...
namespace OpenCV.Photo {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.opencv.photo']/class[@name='MergeDebevec']"
	[global::Android.Runtime.Register ("org/opencv/photo/MergeDebevec", DoNotGenerateAcw=true)]
	public partial class MergeDebevec : global::OpenCV.Photo.MergeExposures {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/opencv/photo/MergeDebevec", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MergeDebevec); }
		}

		protected MergeDebevec (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_J;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.opencv.photo']/class[@name='MergeDebevec']/constructor[@name='MergeDebevec' and count(parameter)=1 and parameter[1][@type='long']]"
		[Register (".ctor", "(J)V", "")]
		protected unsafe MergeDebevec (long p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (MergeDebevec)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::OpenCV.Photo.MergeDebevec __this = global::Java.Lang.Object.GetObject<global::OpenCV.Photo.MergeDebevec> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.opencv.photo']/class[@name='MergeDebevec']/method[@name='process' and count(parameter)=3 and parameter[1][@type='java.util.List&lt;org.opencv.core.Mat&gt;'] and parameter[2][@type='org.opencv.core.Mat'] and parameter[3][@type='org.opencv.core.Mat']]"
