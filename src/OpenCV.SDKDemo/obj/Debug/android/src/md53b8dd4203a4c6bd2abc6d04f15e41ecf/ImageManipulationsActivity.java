package md53b8dd4203a4c6bd2abc6d04f15e41ecf;


public class ImageManipulationsActivity
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("OpenCV.SDKDemo.ImageManipulations.ImageManipulationsActivity, OpenCV.SDKDemo, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ImageManipulationsActivity.class, __md_methods);
	}


	public ImageManipulationsActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ImageManipulationsActivity.class)
			mono.android.TypeManager.Activate ("OpenCV.SDKDemo.ImageManipulations.ImageManipulationsActivity, OpenCV.SDKDemo, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
