package md5156fbfecd0fba21bbd958f612a8a7c6e;


public class MixedProcessingActivity
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("OpenCV.SDKDemo.MixedProcessing.MixedProcessingActivity, OpenCV.SDKDemo, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MixedProcessingActivity.class, __md_methods);
	}


	public MixedProcessingActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MixedProcessingActivity.class)
			mono.android.TypeManager.Activate ("OpenCV.SDKDemo.MixedProcessing.MixedProcessingActivity, OpenCV.SDKDemo, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
